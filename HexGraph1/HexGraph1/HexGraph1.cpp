...
int main()
{
    ...
    manager.ChangeStateOn(Vector3(1, 0, 3), Nodestate::Red);
    manager.ChangeStateOn(Vector3(1, 0, 1), Nodestate::Red);
    ...
    manager.ChangeStateOn(Vector3(4, 0, 2), Nodestate::Red);
    manager.ChangeStateOn(Vector3(5, 0, 1), Nodestate::Red);
    manager.ChangeStateOn(Vector3(2, 0, 3), Nodestate::Red);
    manager.ChangeStateOn(Vector3(6, 0, 1), Nodestate::Red);
